...
Answer:Path. The attack name to exploit this vulnerability is Directory Traversal
...
Answer:Compromised credentials, malicious exployees, missing or poor encryption, etc.
...
Answer:Input Sanitation/Validation and SDLC (Secure Software Deployment Cycles)
____
...
Answer:Implementation costs exceed budget, Management fails to support, Practices fail to be standardized

4. How might an attacker exploit the `robots.txt` file on a web server?

Answer:The robots.txt file can be used to indentify restricted or private areas of a sites contents. The attacker can use those locations to exploit vulnerabilities.

5. What steps can an organization take to obscure or obfuscate their contact information on domain registry web sites?

Answer:Start using a Proxy Service or use a privately registered domain
   
6. True or False: As a network defender, `Client-Side` validation is preferred over `Server-Side` validation because it's easier to defend against attacks.

   - Explain why you chose the answer that you did.

Answer:False - Client-side validation can be easily manipulated by a user and bypassed easily, whereas Server-side validation would require you to manipulate the server which is usually significantly more difficult.
...
1. Define all four factors of multifactor authentication and give examples of each:
   ...
   - Factor 1: Password, PIN
         This factor authenticates based on standard login information
   
   - Factor 2: ID Card, Door Key
         This factor authenticates using physical keys
   
   - Factor 3: Facial Recognition, Fingerprint/Eye Scan
         This factor authenticates using biometrics
   
   - Factor 4: GPS
         This factor authenticates using the location of the device and/or user
   
2. True or False: A password and pin is an example of 2-factor authentication.

Answer:False - They are apart of the same authentication factor
...
Answer:An interface that restricts users based on their privileges
...
(CybersecurityBootcampCoursework\Homework_15_-_Web_Vulnerabilities_and_Hardening\images\Challenge1.png)
...
(CybersecurityBootcampCoursework\Homework_15_-_Web_Vulnerabilities_and_Hardening\images\Challenge2.png)
...
(CybersecurityBootcampCoursework\Homework_15_-_Web_Vulnerabilities_and_Hardening\images\Challenge3.png)
(CybersecurityBootcampCoursework\Homework_15_-_Web_Vulnerabilities_and_Hardening\images\Completion.png)
